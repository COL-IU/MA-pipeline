...
public class GenerateScript{
	...
	bf.append("cd " + this.outLoc + File.separator + this.base + ";java -Xmx7g -Xms3g -jar /nobackup/heewlee/gutGenomes/tools/ProcessSam/ProcessAllSAMs.jar " + this.base + "_PE 0 0.05 " + this.refDir + " " 
